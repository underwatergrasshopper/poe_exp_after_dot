...
class ExpDataSubMenu(PersistentMenu):
    ...
    def __init__(self, parent : "Menu", logic : Logic, control_region : "ControlRegion"):
        ...
        self._characters = {"[Global]" : CharacterData(data_path, data_path + "/exp_data.json")} | self._fetch_characters()
    ...
    def _add_character(self):
        ...
        if name not in ["", "Add", "Remove", "All"]:
            ...
            self._characters[name] = CharacterData(path, file_name)
        ...
        if os.path.exists(characters_path):
            for name in os.listdir(characters_path):
                ...
                if os.path.isfile(exp_data_file_name):
                    characters[name] = CharacterData(path = path, exp_data_file_name = exp_data_file_name)
